...
ALTER TABLE PAR_RUT_ALIM ADD CONSTRAINT PARUTALIM_FK_PAR FOREIGN KEY (ID_PARADERO) REFERENCES PARADERO (ID_PARADERO);
ALTER TABLE PAR_RUT_ALIM ADD CONSTRAINT PARUTALIM_FK_RUTALIM FOREIGN KEY (ID_RUT_ALIM) REFERENCES RUTA_ALIMEN (ID_RUTA_ALIMEN);
